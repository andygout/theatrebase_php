...
<html>
<head>
  <title><?php echo $pagetitle; ?> (text version - playtexts) | TheatreBase</title>
  ...
  <div id="container">
    ...
    <div id="content">
      <div id="results">
        ...
        <?php if($pt['sg_cnt']>count($pt['sg_pts'])) {echo 'Includes (of this text version):';} else {echo 'Comprises:';} ?></td></tr>
        ...
        <?php } else { ?></br><h5><em>NO PLAYTEXTS YET LISTED FOR THIS TEXT VERSION</em></h5><?php } ?>
      </div>
