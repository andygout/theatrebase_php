...
<html>
<head>
  <title><?php echo $pagetitle; ?> (theme - playtexts) | TheatreBase</title>
    ...
    <div id="content">
      <div id="results">
        ...
        <tr class="row<?php echo $rowclass; ?>">
          <td class="prdcol5" colspan="3">▪ <em><?php echo $pt['thm_nm']; ?></em></td>
        </tr>
        <?php } if(!empty($pt['sg_pts'])) { ?>
        <tr class="row<?php echo $rowclass; ?>"><td class="ptcol4" colspan="3">
        <?php if($pt['sg_cnt']>count($pt['sg_pts'])) {echo 'Includes (with this theme):';} else {echo 'Comprises:';} ?></td></tr>
        ...
        <?php } else { ?></br><h5><em>NO PLAYTEXTS YET LISTED FOR THIS THEME</em></h5><?php } ?>
      </div>
