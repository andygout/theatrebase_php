...
<html>
<head>
  <title><?php echo $pagetitle; ?> (feature - playtexts) | TheatreBase</title>
  ...
  <div id="container">
    ...
    <div id="content">
      <div id="results">
        ...
        <?php if($pt['sg_cnt']>count($pt['sg_pts'])) {echo 'Includes (with this feature):';} else {echo 'Comprises:';} ?></td></tr>
        ...
        <?php } else { ?></br><h5><em>NO PLAYTEXTS YET LISTED FOR THIS FEATURE</em></h5><?php } ?>
      </div>
