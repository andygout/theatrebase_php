...
<body>
  <div id="container">
    ...
    <div id="content">
      ...
      <h3><p>Edit this existing company type.</p>
      <p>* Mandatory field.</p></h3>
      <div id="errors">
      <?php echo error_for('comp_typ_edit_error') ?>
      <?php echo error_for('comp_typ_url') ?>
      <?php echo error_for('comp_typ_dlt') ?>
      </div>
      <form action="" method="post">
        <fieldset>
          <div id="comp_typ_nm" class="entry">
            <label for="comp_typ_nm" class="fixedwidth">* COMPANY TYPE: <?php echo error_for('comp_typ_nm') ?></label>
            <input type="text" name="comp_typ_nm" id="comp_typ_nm" maxlength="255" value="<?php echo $comp_typ_nm; ?>" class="entryfield <?php echo errorfield('comp_typ_nm') ?> <?php echo errorfield('comp_typ_url') ?>"/>
            <h6>i.e. Subsidised Theatre / Repertory Theatre / Commercial Theatre Producers / Agency (talent) / Agency (literary) / Publication / Drama School / MRSL Grade 1 / TNC, etc.</h6>
          </div>
        </fieldset>
