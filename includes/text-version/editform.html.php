...
<body>
  <div id="container">
    ...
    <div id="content">
      ...
      <h3><p>Edit this existing text version (**N.B. This will amend the text version details for all other instances in which it is used**).</p>
      <p>* Mandatory field.</p></h3>
      <div id="errors">
      <?php echo error_for('txt_vrsn_edit_error') ?>
      <?php echo error_for('txt_vrsn_url') ?>
      <?php echo error_for('txt_vrsn_dlt') ?>
      </div>
      <form action="" method="post">
        <fieldset>
          <div id="txt_vrsn_nm" class="entry">
            <label for="txt_vrsn_nm" class="fixedwidth">* TEXT VERSION:   <?php echo error_for('txt_vrsn_nm') ?></label>
            <input type="text" name="txt_vrsn_nm" id="txt_vrsn_nm" maxlength="255" value="<?php echo $txt_vrsn_nm; ?>" class="entryfield <?php echo errorfield('txt_vrsn_nm') ?> <?php echo errorfield('txt_vrsn_url') ?>"/>
            <h6>i.e. New / Revival / New Adaptation / New Translation / New Version, etc.</h6>
          </div>
        </fieldset>
