...
<html>
<head>
  <title><?php echo $pagetitle; ?> (category - productions) | TheatreBase</title>
  ...
  <div id="container">
    ...
    <div id="content">
      <div id="results">
        ...
        <?php if($prd['sg_cnt']>count($prd['sg_prds'])) {echo 'Includes (in this category):';} else {echo 'Comprises:';} ?></td></tr>
        ...
        <?php } else { ?></br><h5><em>NO PRODUCTIONS YET LISTED FOR THIS CATEGORY</em></h5><?php } ?>
      </div>
