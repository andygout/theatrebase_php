...
<html>
<head>
  <title><?php echo $pagetitle; ?> (genre - productions) | TheatreBase</title>
    ...
    <div id="content">
      <div id="results">
        ...
        <tr class="row<?php echo $rowclass; ?>">
          <td class="prdcol5" colspan="3">▪ <em><?php echo $prd['gnr_nm']; ?></em></td>
        </tr>
        <?php } if(!empty($prd['sg_prds'])) { ?>
        <tr class="row<?php echo $rowclass; ?>"><td class="prdcol5" colspan="3">
        <?php if($prd['sg_cnt']>count($prd['sg_prds'])) {echo 'Includes (in this genre):';} else {echo 'Comprises:';} ?></td></tr>
        ...
        <?php } else { ?></br><h5><em>NO PRODUCTIONS YET LISTED FOR THIS GENRE</em></h5><?php } ?>
      </div>
