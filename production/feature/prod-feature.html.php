...
<html>
<head>
  <title><?php echo $pagetitle; ?> (feature - productions) | TheatreBase</title>
  ...
  <div id="container">
    ...
    <div id="content">
      <div id="results">
        ...
        <?php if($prd['sg_cnt']>count($prd['sg_prds'])) {echo 'Includes (with this feature):';} else {echo 'Comprises:';} ?></td></tr>
        ...
        <?php } else { ?></br><h5><em>NO PRODUCTIONS YET LISTED FOR THIS FEATURE</em></h5><?php } ?>
      </div>
