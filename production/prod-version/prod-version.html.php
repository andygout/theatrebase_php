...
<html>
<head>
  <title><?php echo $pagetitle; ?> (production version) | TheatreBase</title>
  ...
  <div id="container">
    ...
    <div id="content">
      <div id="results">
        ...
        <?php if($prd['sg_cnt']>count($prd['sg_prds'])) {echo 'Includes (of this production version):';} else {echo 'Comprises:';} ?></td></tr>
