...
<body>
  <div id="container">
    ...
    <div id="content">
      ...
      <h3><p>Edit this existing festival.</p>
      <p>* Mandatory field.</p></h3>
      <div id="errors">
      <?php echo error_for('fstvl_edit_error') ?>
      <?php echo error_for('fstvl_url') ?>
      <?php echo error_for('fstvl_dlt') ?>
      </div>
      ...
      <form action="" method="post">
        <fieldset>
          <div id="fstvl_nm" class="entry">
            ...
            <input type="text" name="fstvl_nm" id="fstvl_nm" maxlength="255" value="<?php echo $fstvl_nm; ?>" class="entryfield <?php echo errorfield('fstvl_nm') ?> <?php echo errorfield('fstvl_url') ?>"/>
            <h6>i.e. RSC Complete Works Festival / Edinburgh Fringe Festival 2012, etc.</h6>
          </div>
        </fieldset>
